...
|---|---|---|---|---|
| RF-001 | SKN-040–043 | G3 | E2E criar, entrar, recuperar e sair | [EV-SKN-040](evidencias/SKN-040.md) parcial; SKN-041–043 pendentes |
...
|---|---|---|---|
| CA-001 — Primeira geração | SKN-056 / SKN-085 / SKN-090 | G3 | Pendente |
...
| Brand Guide + SKN-003 | identidade, paleta, voz, landing e autenticação visual | SKN-031/032 | Implementação local; evidência remota pendente |
