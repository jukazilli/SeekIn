...
a marca/landing verificadas no `SKN-032`, a entrada/sessão concluída no `SKN-041` e a saída segura
concluída no `SKN-042`, a sequência segue para recuperação de acesso pelo `SKN-043`.
